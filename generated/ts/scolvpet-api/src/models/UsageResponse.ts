...
import type { UsageResponseData } from './UsageResponseData';
import {
    UsageResponseDataFromJSON,
    UsageResponseDataFromJSONTyped,
    UsageResponseDataToJSON,
    UsageResponseDataToJSONTyped,
} from './UsageResponseData';
...
export function UsageResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageResponse {
    ...
    return {
        ...
        'data': UsageResponseDataFromJSON(json['data']),
...
export function UsageResponseToJSONTyped(value?: UsageResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': UsageResponseDataToJSON(value['data']),
