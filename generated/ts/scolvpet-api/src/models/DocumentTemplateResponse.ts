...
/**
 * Check if a given object implements the DocumentTemplateResponse interface.
 */
export function instanceOfDocumentTemplateResponse(value: object): value is DocumentTemplateResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function DocumentTemplateResponseFromJSON(json: any): DocumentTemplateResponse {
    return DocumentTemplateResponseFromJSONTyped(json, false);
}

export function DocumentTemplateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentTemplateResponse {
    if (json == null) {
        return json;
    }
    return {

        'data': DocumentTemplateFromJSON(json['data']),
        'meta': ResponseMetaFromJSON(json['meta']),
    };
}

export function DocumentTemplateResponseToJSON(json: any): DocumentTemplateResponse {
    return DocumentTemplateResponseToJSONTyped(json, false);
}

export function DocumentTemplateResponseToJSONTyped(value?: DocumentTemplateResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': DocumentTemplateToJSON(value['data']),
