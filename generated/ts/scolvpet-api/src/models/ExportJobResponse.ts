...
export function ExportJobResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExportJobResponse {
    ...
    return {
        ...
        'data': ExportJobFromJSON(json['data']),
        'meta': ResponseMetaFromJSON(json['meta']),
    };
}

export function ExportJobResponseToJSON(json: any): ExportJobResponse {
    return ExportJobResponseToJSONTyped(json, false);
}

export function ExportJobResponseToJSONTyped(value?: ExportJobResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ExportJobToJSON(value['data']),
