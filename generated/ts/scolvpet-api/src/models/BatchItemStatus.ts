...
export const BatchItemStatus = {
    ...
    SucceededWithException: 'succeeded_with_exception'
} as const;
...
export function instanceOfBatchItemStatus(value: any): boolean {
    for (const key in BatchItemStatus) {
        if (Object.prototype.hasOwnProperty.call(BatchItemStatus, key)) {
            if (BatchItemStatus[key as keyof typeof BatchItemStatus] === value) {
                return true;
            }
        }
    }
...
export function BatchItemStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): BatchItemStatus {
