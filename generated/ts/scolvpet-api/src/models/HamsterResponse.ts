...
/**
 * Check if a given object implements the HamsterResponse interface.
 */
export function instanceOfHamsterResponse(value: object): value is HamsterResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function HamsterResponseFromJSON(json: any): HamsterResponse {
    return HamsterResponseFromJSONTyped(json, false);
}

export function HamsterResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HamsterResponse {
    if (json == null) {
        return json;
    }
    return {

        'data': HamsterFromJSON(json['data']),
        'meta': ResponseMetaFromJSON(json['meta']),
    };
}

export function HamsterResponseToJSON(json: any): HamsterResponse {
    return HamsterResponseToJSONTyped(json, false);
}

export function HamsterResponseToJSONTyped(value?: HamsterResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
