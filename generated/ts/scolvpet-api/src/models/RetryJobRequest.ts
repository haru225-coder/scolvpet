...
export interface RetryJobRequest {
     ...
     *
     * @type {string}
     * @memberof RetryJobRequest
     */
    reason: string;
}

/**
 * Check if a given object implements the RetryJobRequest interface.
 */
export function instanceOfRetryJobRequest(value: object): value is RetryJobRequest {
    if (!('reason' in value) || value['reason'] === undefined) return false;
    return true;
}

export function RetryJobRequestFromJSON(json: any): RetryJobRequest {
    return RetryJobRequestFromJSONTyped(json, false);
}

export function RetryJobRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetryJobRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function RetryJobRequestToJSON(json: any): RetryJobRequest {
    return RetryJobRequestToJSONTyped(json, false);
}

export function RetryJobRequestToJSONTyped(value?: RetryJobRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
