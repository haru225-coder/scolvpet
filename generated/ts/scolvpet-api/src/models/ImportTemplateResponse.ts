...
import type { ImportTemplateResponseData } from './ImportTemplateResponseData';
import {
    ImportTemplateResponseDataFromJSON,
    ImportTemplateResponseDataFromJSONTyped,
    ImportTemplateResponseDataToJSON,
    ImportTemplateResponseDataToJSONTyped,
} from './ImportTemplateResponseData';
...
export interface ImportTemplateResponse {
    /**
     * 
     * @type {ImportTemplateResponseData}
     * @memberof ImportTemplateResponse
     */
    data: ImportTemplateResponseData;
    /**
     * 
     * @type {ResponseMeta}
     * @memberof ImportTemplateResponse
 ...
 */
export function instanceOfImportTemplateResponse(value: object): value is ImportTemplateResponse {
...
export function ImportTemplateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImportTemplateResponse {
    ...
    return {
        ...
        'data': ImportTemplateResponseDataFromJSON(json['data']),
        'meta': ResponseMetaFromJSON(json['meta']),
    };
}

export function ImportTemplateResponseToJSON(json: any): ImportTemplateResponse {
    return ImportTemplateResponseToJSONTyped(json, false);
}

export function ImportTemplateResponseToJSONTyped(value?: ImportTemplateResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ImportTemplateResponseDataToJSON(value['data']),
