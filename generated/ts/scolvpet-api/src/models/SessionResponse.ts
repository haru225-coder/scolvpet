...
import {
    SessionResponseDataFromJSON,
    SessionResponseDataFromJSONTyped,
    SessionResponseDataToJSON,
    SessionResponseDataToJSONTyped,
} from './SessionResponseData';
...
export function SessionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionResponse {
    ...
    return {
        ...
        'data': SessionResponseDataFromJSON(json['data']),
...
export function SessionResponseToJSONTyped(value?: SessionResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': SessionResponseDataToJSON(value['data']),
