...
export function instanceOfReminderState(value: any): boolean {
    for (const key in ReminderState) {
        if (Object.prototype.hasOwnProperty.call(ReminderState, key)) {
            if (ReminderState[key as keyof typeof ReminderState] === value) {
                return true;
            }
        }
    }
...
export function ReminderStateFromJSON(json: any): ReminderState {
    return ReminderStateFromJSONTyped(json, false);
}

export function ReminderStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReminderState {
    return json as ReminderState;
}

export function ReminderStateToJSON(value?: ReminderState | null): any {
    return value as any;
}

export function ReminderStateToJSONTyped(value: any, ignoreDiscriminator: boolean): ReminderState {
