 ...
 */
export function instanceOfImportUploadResponse(value: object): value is ImportUploadResponse {
...
export function ImportUploadResponseToJSON(json: any): ImportUploadResponse {
    return ImportUploadResponseToJSONTyped(json, false);
}

export function ImportUploadResponseToJSONTyped(value?: ImportUploadResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
