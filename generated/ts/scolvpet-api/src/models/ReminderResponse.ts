...
export function ReminderResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReminderResponse {
    ...
    return {
        ...
        'data': ReminderFromJSON(json['data']),
        'meta': ResponseMetaFromJSON(json['meta']),
    };
}

export function ReminderResponseToJSON(json: any): ReminderResponse {
    return ReminderResponseToJSONTyped(json, false);
}

export function ReminderResponseToJSONTyped(value?: ReminderResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ReminderToJSON(value['data']),
