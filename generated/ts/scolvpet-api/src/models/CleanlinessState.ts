...
export const CleanlinessState = {
    Clean: 'clean',
    PartialDue: 'partial_due',
    FullDue: 'full_due'
} as const;
export type CleanlinessState = typeof CleanlinessState[keyof typeof CleanlinessState];


export function instanceOfCleanlinessState(value: any): boolean {
    for (const key in CleanlinessState) {
        if (Object.prototype.hasOwnProperty.call(CleanlinessState, key)) {
            if (CleanlinessState[key as keyof typeof CleanlinessState] === value) {
                return true;
            }
        }
    }
...
export function CleanlinessStateFromJSON(json: any): CleanlinessState {
    return CleanlinessStateFromJSONTyped(json, false);
}

export function CleanlinessStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): CleanlinessState {
    return json as CleanlinessState;
}

export function CleanlinessStateToJSON(value?: CleanlinessState | null): any {
    return value as any;
}

export function CleanlinessStateToJSONTyped(value: any, ignoreDiscriminator: boolean): CleanlinessState {
    return value as CleanlinessState;
}
