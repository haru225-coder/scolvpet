...
class GeneticApi {
  ...
  Future<Response<Map<String, Object>>> compareGeneticActual({
    ...
    final _path = r'/v1/genetic/compare-actual';
...
_responseData = rawData == null ? null : deserialize<Map<String, Object>, Object>(rawData, 'Map<String, Object>', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Map<String, Object>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, Object>>> inferGeneticParents({
    required Map<String, Object> requestBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/genetic/infer-parents';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<Map<String, Object>, Object>(rawData, 'Map<String, Object>', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Map<String, Object>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, Object>>> listGeneticFeedbackSummary({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/genetic/feedback-summary';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<Map<String, Object>, Object>(rawData, 'Map<String, Object>', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Map<String, Object>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, Object>>> listGeneticPhenotypeCatalog({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/genetic/phenotype-catalog';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<Map<String, Object>, Object>(rawData, 'Map<String, Object>', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Map<String, Object>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, Object>>> listGeneticTargetCrosses({
    ...
    final _path = r'/v1/genetic/target-crosses';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
