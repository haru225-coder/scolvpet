...
class DocumentTemplateResponse {
  /// Returns a new [DocumentTemplateResponse] instance.
  ...
  final ResponseMeta meta;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is DocumentTemplateResponse &&
      other.data == data &&
      other.meta == meta;
