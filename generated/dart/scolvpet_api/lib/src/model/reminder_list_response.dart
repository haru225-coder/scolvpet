...
class ReminderListResponse {
  /// Returns a new [ReminderListResponse] instance.
  ...
  final ResponseMeta meta;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ReminderListResponse &&
      other.data == data &&
      other.page == page &&
      other.meta == meta;
  ...
  factory ReminderListResponse.fromJson(Map<String, dynamic> json) => _$ReminderListResponseFromJson(json);
