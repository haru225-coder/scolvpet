...
void main() {
  ...
  testWidgets(
    'public-style reservation shows customer hamster time and actions',
    (tester) async {
      ...
      await tester.pumpAndSettle();
      expect(
        find.byKey(const Key('crm-reservation-confirm-action')),
        findsOneWidget,
      );
      ...
      await tester.pumpAndSettle();
      expect(
        find.byKey(const Key('crm-reservation-schedule-delivery')),
        findsOneWidget,
      );
      expect(
        find.byKey(const Key('crm-reservation-open-contract')),
        findsOneWidget,
      );
    },
  );
