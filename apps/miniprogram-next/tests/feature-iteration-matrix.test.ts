...
const featureIterationRows: FeatureIterationRow[] = [
  ...
  { route: 'pages/population/index', domain: 'B 种群', criticalFlow: '窝次/个体横滑与管理主路径', testFile: 'tests/migration-surface.test.ts', deviceEvidence: evidencePath },
  { route: 'pages/trial/index', domain: '遗传', criticalFlow: '底栏试配主路径出中文结论', testFile: 'tests/pedigree-from-litters.test.ts', deviceEvidence: evidencePath },
  { route: 'pages/today/index', domain: 'B 今日', criticalFlow: '今日任务读取、完成、延期与刷新（离栏保留）', testFile: 'tests/pages.test.tsx', deviceEvidence: evidencePath },
  { route: 'pages/business/index', domain: 'B 经营', criticalFlow: '客户与经营入口（离栏保留）', testFile: 'tests/migration-surface.test.ts', deviceEvidence: evidencePath },
  ...
  { route: 'packages/animals/detail/index', domain: '个体', criticalFlow: '建档改档能存；快捷「看族谱」', testFile: 'tests/migration-surface.test.ts', deviceEvidence: evidencePath },
  { route: 'packages/animals/create/index', domain: '个体', criticalFlow: '建档一只', testFile: 'tests/migration-surface.test.ts', deviceEvidence: evidencePath },
